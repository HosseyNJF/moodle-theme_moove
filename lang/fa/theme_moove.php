...
$string['pluginname'] = 'موو';
$string['configtitle'] = 'موو';
$string['choosereadme'] = 'موو یک قالب بسیار شخصی‌سازی شونده است. این قالب می‌تواند به شکل مستقیم یا به عنوان والد تم‌هایی که از Bootstrap 4 استفاده می‌کنند استفاده شود.';

$string['currentinparentheses'] = '(فعلی)';
$string['region-side-pre'] = 'راست';
$string['login'] = 'از قبل یک حساب کاربری دارید?';
$string['prev_section'] = 'بخش قبلی';
$string['next_section'] = 'بخش بعدی';
$string['search_site'] = 'جستجو در سایت';
$string['search_forums'] = 'جستجو در انجمن درس';
$string['platform_access'] = 'دسترسی به پلتفرم';
$string['readmore'] = 'ادامه مطلب';
$string['stayintouch'] = 'در تماس باشید';
$string['madewitmoodle'] = 'با افتخار، ساخته‌شده توسط';
$string['madeby'] = 'ساخته‌شده توسط';
$string['by'] = 'توسط';
...
$string['diskusage'] = 'مصرف هارد (moodledata)';
$string['notcalculatedyet'] = 'محاسبه‌نشده';
$string['calculatediskusagetask'] = 'محاسبه‌گر مصرف هارددیسک';
$string['totalusers'] = 'تعداد کاربران فعال/تعلیقی';
$string['totalcourses'] = 'تعداد درس‌ها';
$string['onlineusers'] = 'کاربران آنلاین (۵ دقیقه اخیر)';
$string['showhideblocks'] = 'نمایش/مخفی کردن بلاک‌ها';
...
$string['certificates'] = 'مدرک‌ها';
$string['certificatestitle'] = 'مدرک‌های من';
$string['subtitleallcertificates'] = 'مدرک‌های تمام درس‌ها';
$string['subtitlecoursecertificates'] = 'مدرک‌های درس';
$string['nohavecertificates'] = 'هنوز هیچ مدرکی دریافت نکرده‌اید';
$string['coursesections'] = 'بخش‌های درس';

// Mypublic page.
$string['userprofile'] = 'پروفایل کاربر';
$string['competencyplans'] = 'برنامه‌های شایستگی';
$string['details'] = 'جزئیات';
$string['startedon'] = 'شروع‌شده در';
$string['addcontact'] = 'افزودن مخاطب';
$string['removecontact'] = 'حذف مخاطب';
$string['certificates'] = 'گواهی‌ها';

// Theme settings.
$string['themesettingstitle'] = 'تنظیمات دسترس‌پذیری';
$string['themesettingsfonttype'] = 'نوع قلم';
$string['themesettingsdefaultfont'] = 'قلم پیش‌فرض';
$string['themesettingsdyslexicfont'] = 'قلم مخصوص افراد نارسا‌خوان';
$string['themesettingsenableaccessibilitytoolbar'] = 'فعال‌کردن نوار ابزار دسترس‌پذیری';
$string['themesettinggsavedsuccessfully'] = 'تنظیمات دسترس‌پذیری با موفقیت ذخیره شدند.';

// Accessibility features.
$string['accessibilityfontsize'] = 'اندازه قلم';
$string['accessibilitydecreasefont'] = 'کاهش اندازه قلم';
$string['accessibilityresetfont'] = 'بازنشانی اندازه قلم';
$string['accessibilityincreasefont'] = 'افزایش اندازه قلم';
$string['accessibilitysitecolor'] = 'رنگ سایت';
$string['accessibilityresetsitecolor'] = 'بازنشانی رنگ سایت';
$string['accessibilitysitecolor2'] = 'کنتراست پایین ۱';
$string['accessibilitysitecolor3'] = 'کنتراست پایین ۲';
